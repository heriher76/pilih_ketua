...
<head>
  ...
  <link href="{{url('sb-admin/vendor/datatables/dataTables.bootstrap4.css')}}" rel="stylesheet">
...
<body id="page-top">
  ...
  <script src="{{url('sb-admin/vendor/datatables/jquery.dataTables.js')}}"></script>
  <script src="{{url('sb-admin/vendor/datatables/dataTables.bootstrap4.js')}}"></script>

  <!-- Custom scripts for all pages-->
  <script src="{{url('sb-admin/js/sb-admin.min.js')}}"></script>
